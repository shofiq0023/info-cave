...
public class GetBlogsByUserDAO {
	DAO dao = new DAO();
	
	String statement = "SELECT * FROM blogs WHERE user_id=?";
	
	public List<Blogs> getBlogs(int userId) throws ClassNotFoundException, SQLException {
